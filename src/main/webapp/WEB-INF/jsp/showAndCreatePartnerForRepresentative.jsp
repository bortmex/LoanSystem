...
<script type="text/javascript" src="resources/js/respUserDatatables.js" defer></script>
<head>
...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6">
                    <h2><spring:message code="representative.allpartner"/></h2>
                </div>
                <div class="col-sm-6">
                    <a onclick="add()" class="btn btn-default"><i class="material-icons">&#xE147;</i> <span><spring:message code="partner.add"/></span></a>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title"><spring:message code="partner.add"/></h2>
            </div>
